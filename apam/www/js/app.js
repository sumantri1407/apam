...
const nama_instansi = 'RUMKIT TK. IV Dr. SUMANTRI'; // Hospital Name
const apiUrl = 'http://www.rumkitsumantri.or.id/APAM-Rumkit-Sumantri/pasien-rest/'; // API Server URL
...
var app  = new Framework7({
  ...
  id: 'or.id.rukmkitsumantri.apam', // App bundle ID
  name: 'APAM RUMKIT Dr. SUMANTRI', // App name
  dialog: {
    title: 'Peringatan',
    buttonOk: 'Ya',
    buttonCancel: 'Tidak'
...
if (debug == '1') {
  ...
  function appReady(){
    ...
    document.addEventListener('resume', function(){
      ga('send', 'pageview' , {'location' : 'http://www.rumkitsumantri.or.id/pasien-rest/index.html' });
    }, false);
